...
class MarkdownToDelta {
    ...
    _parseText(text) {
        ...
        if (this.mentions && this.mentions.length > 0) {
            for (const mention of this.mentions) {
                parser.addRule(mention.reg, (tag, ...args) => {
        ...
        // Link
        parser.addRule(/\[(.*?)\]\(([-a-zA-Z0-9@:%_\+.~#?&\/\(\)=]*)\)/gi, (tag, linkLabel, linkUrl) => {
    ...
    _convertTreeNodesToCustomNodes(treeNodes, previousNode, types = [], subItem = false) {
        ...
        for (const treeItem of treeNodes) {
            if (treeItem.type === 'text') {
                ...
                const mention = (_a = this.mentions) === null || _a === void 0 ? void 0 : _a.find(m => m.type === treeItem.value.type);
                const mValue = mention === null || mention === void 0 ? void 0 : mention.values.find(mv => mv.value.toString() === treeItem.value.args[0].toString());
                if (mention && mValue) {
                    node.options = {
                        "index": "0",
                    ...
                    node.options = {
                        "index": "0",
                        "denotationChar": mention === null || mention === void 0 ? void 0 : mention.denotationChar,
                        "value": '',
                ...
                if (subItem) {
                    ...
                    innerNode.options = ((_b = treeItem.value) === null || _b === void 0 ? void 0 : _b.options) || null;
                }
                else {
                    node.previousNode = lastNode;
                    lastNode.nextNode = node;
                    ...
                    lastNode.options = ((_c = treeItem.value) === null || _c === void 0 ? void 0 : _c.options) || null;
                }
            }
        }
        return lastNode;
    ...
    _normalizeDelta(convertedOps) {
        ...
        for (let i = 0; i < convertedOps.length; i++) {
            ...
            if (opItem.insert.startsWith('\n') && opItem.insert.length > 1 && ((_a = lastOps === null || lastOps === void 0 ? void 0 : lastOps.attributes) === null || _a === void 0 ? void 0 : _a.list)) {
...
export const markdownToDelta = (md, mentions) => {
